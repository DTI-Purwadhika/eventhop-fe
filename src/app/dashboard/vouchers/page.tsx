    ...
    <Tabs defaultValue="all">
      ...
      <TabsContent value="all">
        <Card x-chunk="dashboard-06-chunk-0">
          <CardHeader>
            <CardTitle>Vouchers & Promos</CardTitle>
            <CardDescription>
              Manage your vouchers and promos and view their details.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
              ...
              <TableBody>
                ...
                <TableRow>
                  <TableCell className="font-medium">Business Boost</TableCell>
                  <TableCell>Discount %</TableCell>
                  <TableCell>15%</TableCell>
                  <TableCell>Business Summit</TableCell>
                  <TableCell>10/30</TableCell>
                  <TableCell>BOOST15</TableCell>
                ...
                {/* Add more promo rows as needed */}
              </TableBody>
            </Table>
          </CardContent>
          <CardFooter>
            <div className="text-xs text-muted-foreground">
              Showing <strong>1-4</strong> of <strong>4</strong> promos
            </div>
          </CardFooter>
        </Card>
      </TabsContent>
